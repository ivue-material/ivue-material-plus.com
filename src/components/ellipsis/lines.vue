<template>
    <h4>lines</h4>
    <ivue-ellipsis style="width:400px;margin: 0 auto;" :text="text" :lines="3" tooltip></ivue-ellipsis>
    <h4>v-line-clamp</h4>
    <ivue-ellipsis style="width:400px;margin: 0 auto;" :text="text" v-line-clamp="2" tooltip></ivue-ellipsis>
</template>
