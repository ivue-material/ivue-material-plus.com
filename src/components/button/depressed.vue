<template>
  ...
  <ivue-button class="button" status="light-primary" depressed
    >Light Primary</ivue-button
  >
  <ivue-button class="button" status="dark-primary" depressed
    >Dark Primary</ivue-button
  >
