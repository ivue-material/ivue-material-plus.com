<template>
  <ivue-checkbox v-model="capture" @on-change="handleChange"
    >设置为捕获事件，设置后请刷新页面重新点击查看</ivue-checkbox
  >
  <div
  ...
  <ivue-button class="click-outside-button" @click="handleButton"
    >点击按钮查看事件触发顺序</ivue-button
  >
</template>
