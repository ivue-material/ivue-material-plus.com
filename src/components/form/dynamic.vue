<template>
  <ivue-form :model="formData" :label-width="120" ref="formRef">
    ...
    <ivue-form-item>
      <ivue-button class="form-demo-button" outline @click="handleAdd"
        >+ Add Item</ivue-button
      >
    </ivue-form-item>

    <ivue-form-item>
      <ivue-button
        class="form-demo-button"
        status="primary"
        @click="handleSubmit"
        >Submit</ivue-button
      >
      <ivue-button class="form-demo-button" @click="handleReset"
        >Reset</ivue-button
      >
    </ivue-form-item>
  </ivue-form>
