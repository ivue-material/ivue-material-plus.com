<template>
  ...
  <h4>手动更新</h4>
  <ivue-button class="menu-button" @click="handleUpdateOpened"
    >手动更新展开的子目录</ivue-button
  >
  <ivue-button class="menu-button" @click="handleUpdateActiveName"
    >手动更新当前选择项</ivue-button
  >
</template>
