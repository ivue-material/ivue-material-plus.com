<template>
  <div>
    <h1>Elevation 海拔</h1>
    <p>
      阴影提供有关物体深度和方向运动的重要视觉线索。它们是唯一的视觉提示，表明表面之间的分离量。
      <code>Elevation</code> 确定其阴影的外观。 <code>Elevation</code>值在
      <code>“Z-空间”</code>和范围映射出 <code>0</code>到
      <code>24</code>的深度。你可以在 <code>class</code> 里面引入
      <code>ivue-elevation-[size]</code> 设置显示的深度。
    </p>
    <h2>首先引入CSS</h2>
