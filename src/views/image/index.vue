<template>
  <div class="images">
    ...
    <p>
      可通过
      <code>slot = loading</code>或 <code>loading-text</code>属性
      加载中占位内容， <code>slot = error</code> 或
    ...
    <p>
      ...
      <code>overflow</code> 值为 <code>auto</code> 或
    ...
    <p>
      ...
      <code>←</code> 、 <code>→</code> 切换图片， <code>↑</code> 、
      <code>↓</code>
      缩放图片，
      <code>Space</code>
      显示
      <code>1:1</code> 图片， <code>ESC</code> 退出预览。
    </p>
...
const propsData = ref([
  ...
  },
  {
    ...
    type: 'String',
    value:
      '<code>fill</code> | <code>contain</code> | <code>cover</code> | <code>none</code> | <code>scale-down</code>',
    default: '-',
  },
  {
    name: 'alt',
  ...
  },
  {
    ...
    type: 'String',
    value:
      '<code>no-referrer</code> | <code>no-referrer-when-downgrade</code> | <code>origin</code> | <code>origin-when-cross-origin</code> | <code>same-origin</code> ｜ <code>strict-origin</code> | <code>strict-origin-when-cross-origin</code> | <code>unsafe-url</code>',
    default: '-',
  },
  {
    name: 'lazy',
