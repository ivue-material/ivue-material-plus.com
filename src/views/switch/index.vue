<template>
    <div>
        ...
        <p>
            当设置
            <code>color</code>/
            <code>false-color</code> 为数组时自动开启渐变
        </p>
        ...
        <p>
            设置属性
            <code>before-change</code> 并返回 Promise，可以阻止切换
        </p>
        <doc-markdown :code="code.beforeChange">
            <template #demo>
...
import Loading from '@/components/switch/loading.vue';
