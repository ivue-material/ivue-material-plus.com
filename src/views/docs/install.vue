<template>
    <div class="install">
        ...
        <p>
            ...
            >ES2018</a>
            <span>和</span>
            <a class="link" target="_blank" href="https://caniuse.com/resizeobserver">ResizeObserver</a>
            <span>的浏览器上运行。 如果您确实需要支持旧版本的浏览器，请自行添加</span>
            <a class="link" target="_blank" href="https://babeljs.io/">Babel</a>
            <span>
                和相应的
                <code>Polyfill</code>
            </span>
        </p>
        <p>由于 Vue 3 不再支持 IE11，该库也不再支持 IE 浏览器。</p>
        <h2>CDN 引入</h2>
        <p>
            <span>你可以通过</span>
            <a
        ...
        <doc-markdown :code="code.example" :showPlayground="false">
            <template #demo>
                <example></example>
            </template>
        </doc-markdown>
