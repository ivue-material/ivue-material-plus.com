<template>
    <div class="notice-wrapper">
        ...
        <p>通过直接调用以下方法来使用组件:</p>
        <ul class="ul">
            <li class="li">this.$notice.open(options)</li>
            <li class="li">this.$notice.info(options)</li>
            <li class="li">this.$notice.success(options)</li>
            <li class="li">this.$notice.warning(options)</li>
            <li class="li">this.$notice.error(options)</li>
        </ul>
        <p>
            参数
        ...
        <ul class="ul">
            ...
            <li class="li">
                ...
                <code>userOnClose(用户关闭时调用的回调)</code>)
            </li>
            <li class="li">this.$notice.destroy(options)</li>
        </ul>
