<template>
    <div>
        ...
        <doc-markdown :code="code.radioGroup">
            <template #demo>
...
const radioPropsData = ref([
    {
        name: 'model-value',
        illustrate:
            '只在单独使用时有效。可以使用 <code>v-model</code> 双向绑定数据',
        type: 'Boolean',
        default: 'false',
    },
    {
        name: 'label',
        illustrate:
            '指定当前选项的 <code>value</code> 值，在组合中使用时会自动判断当前选择的项目',
        type: 'String | Number',
        default: '-',
    },
    {
